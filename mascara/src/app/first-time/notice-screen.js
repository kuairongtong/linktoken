...
class NoticeScreen extends Component {
  ...
  render () {
    ...
    const currentLocale = (window.metamask && window.metamask.metamask && window.metamask.metamask.currentLocale) || 'zh_CN'
    const bodyContent =  (body && body[currentLocale]) || ''
    const titleContent = (title && t(title.replace(/\s/g,'_'))) || ''
    return (
      isLoading
        ? <LoadingScreen />
        : (
            ...
            <div className="first-view-main-wrapper">
              <div className="first-view-main">
                ...
                >
                  ...
                  <div className="tou__title">{titleContent}</div>
                  <Markdown
