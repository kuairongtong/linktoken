...
class BuyEtherScreen extends Component {
  ...
  renderCoinbaseForm () {
    ...
    return (
      <div className="buy-ether__action-content-wrapper">
        ...
        <a className="first-time-flow__link buy-ether__faq-link">What is LinkToken?</a>
  ...
  renderContent () {
    ...
    qrImage.addData(address.toLocaleLowerCase())
    qrImage.make()
      ...
      case OPTION_VALUES.QR_CODE:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            <div className="buy-ether__small-body-text">(This is the account address that Linker created for you to recieve funds.)</div>
            <div className="buy-ether__buttons">
              <button
                className="first-time-flow__button"
  ...
  render () {
    ...
    return (
      <div className="buy-ether">
        ...
        <div className="buy-ether__body-text">
          Linker works best if you have Ether in your account to pay for transaction gas fees and more. To get Ether, choose from one of these methods.
        </div>
