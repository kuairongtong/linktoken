...
class BackupPhraseScreen extends Component {
  ...
  exportSeedWords = () => {
    ...
    exportAsFile('Linker Secret Backup Phrase', seedWords, 'text/plain')
  }
    ...
    return (
      <div className="backup-phrase__content-wrapper">
        <div className="backup-phrase__phrase">
          <div className="backup-phrase__title">{t('Secret_Backup_Phrase')}</div>
          <div className="backup-phrase__body-text">{t('secretBackupPhraseDesc1')}</div>
          <div className="backup-phrase__body-text">{t('secretBackupPhraseDesc2')}</div>
          {this.renderSecretWordsContainer()}
        </div>
        <div className="backup-phrase__tips">
          <div className="backup-phrase__tips-text">{t('tips')}:</div>
          <div className="backup-phrase__tips-text">{t('secretBackupTips1')}</div>
          <div className="backup-phrase__tips-text">{t('secretBackupTips2')}</div>
