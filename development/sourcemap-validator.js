...
//
// searches `dist/chrome/lkpage.js` for "new Error" statements
...
async function start () {
  const rawBuild = fs.readFileSync(path.join(__dirname, '/../dist/chrome/', 'lkpage.js')
  , 'utf8')
  const rawSourceMap = fs.readFileSync(path.join(__dirname, '/../dist/sourcemaps/', 'lkpage.js.map'), 'utf8')
