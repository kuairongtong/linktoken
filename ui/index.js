...
async function startApp (metamaskState, accountManager, opts) {
  ...
  if (!metamaskState.currentLocale) {
      metamaskState.currentLocale = window.navigator.language && window.navigator.language.replace('-','_')
  }

  if ( metamaskState.currentLocale == "zh-cn" || metamaskState.currentLocale == "zh_cn")
      metamaskState.currentLocale = "zh_CN"
